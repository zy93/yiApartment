...
//@property(nonatomic, strong)UILabel * otherTalkLabel;
...
-(void)layoutSubviews{
    ...
    [_genderImv mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(_nameLabel.mas_right).offset(SIZE_SCALE_IPHONE6(5));
    ...
    [_headBT mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(_headImv.mas_left);

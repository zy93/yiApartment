...
//    _headImv.backgroundColor = [UIColor cyanColor];
    [_headImv sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",BaseImageURL,self.personModel.UHeadPortrait]] placeholderImage:[UIImage imageNamed:placeholdPicture]];
...
//    _areaLabel.backgroundColor = [UIColor grayColor];
    ...
    _showContent.text = self.personModel.ShowCont;
...
-(NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    NSArray * array = [self.personModel.ShowPic componentsSeparatedByString:@";"];
...
//    cell.backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString stringWithFormat:@"/uploadFiles/uploadImgs/%@",string]]];
    ...
    [imv sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",BaseImageURL, string]]];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    pictureVC.aString = [NSString stringWithFormat:@"%@%@", BaseImageURL,string];

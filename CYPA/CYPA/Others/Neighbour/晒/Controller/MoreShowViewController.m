...
-(void)makeData {
    ...
    //所有邻居动态列表信息
    [[GXNetWorkManager shareInstance] getInfoWithUID:nil apartmentID:@"1" Type:nil path:@"/user/getNeighborShowList" success:^(NSMutableDictionary * dict) {
...
//            NSLog(@"%@",self.neighbourDataArray);
    ...
    //所有公民动态列表信息
    [[GXNetWorkManager shareInstance] getInfoWithUID:nil apartmentID:nil Type:nil path:@"/user/getShowList" success:^(NSMutableDictionary * dict) {
...
-(void)setupViews{
    ...
    self.neighbourLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(15)];
    ...
    self.citizenLabel.textColor = [UIColor redColor];
    self.citizenLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(15)];
...
-(void)allCitizen {
    ...
    self.neighbourLabel.textColor = [UIColor redColor];
    //换数组
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.headImv sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://123.57.156.227:8080/AppImages/%@",model.UHeadPortrait]]];
    cell.nameLabel.text = model.UNickName;
    cell.showContent.text = model.UShowCont;
    cell.imageString = model.UShowPic;

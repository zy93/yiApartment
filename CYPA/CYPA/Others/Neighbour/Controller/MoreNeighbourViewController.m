...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.headImv sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://123.57.156.227:8080/AppImages/%@",model.UHeadPortrait]] placeholderImage:[UIImage imageNamed:placeholdPicture]];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    personVC.personModel = self.dataArray[indexPath.section];
...
-(void)allNeighbour {
    [self.neighbourBT setBackgroundImage:[UIImage imageNamed:@"975"] forState:(UIControlStateNormal)];
    self.neighbourLabel.textColor = [UIColor whiteColor];
    [self.citizenBT setImage:[UIImage imageNamed:@"977"] forState:(UIControlStateNormal)];
    self.citizenLabel.textColor = [UIColor redColor];

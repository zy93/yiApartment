...
-(void)setupViews {
    ...
    _lastLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(15)];
    ...
    _oldLabel.text = @"以往活动";
    _oldLabel.textColor = [UIColor redColor];
    _oldLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(15)];
...
-(void)newTrystAction {
    ...
    [self.oldTrystBT setBackgroundImage:[UIImage imageNamed:@"977"] forState:(UIControlStateNormal)];
    self.oldLabel.textColor = [UIColor redColor];
    //换数组
    self.dataArray = self.lastTrystArray;
    [self.tableView reloadData];
//    NSLog(@"%@",self.dataArray);
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    activityVC.activityModel = self.dataArray[indexPath.section];

...
//    NSNumber *number = [NSNumber numberWithInt:self.activityModel.GroupID];
    NSLog(@"%@", self.activityModel.GroupID);
    
    [dictory setValue:self.activityModel.GroupID forKey:@"GroupID"];
...
//            NSLog(@"%@", self.detailModel.UHeadPortrait);
            ...
            for (NSDictionary * dic in dict[@"data"][@"Person"]) {
                ...
                //参与人照片
                [self.perArray addObject: dic[@"UHeadPortrait"]];
            ...
            //设置
            [_headImv sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://123.57.156.227:8080/AppImages/%@",self.detailModel.UHeadPortrait]] placeholderImage:[UIImage imageNamed:placeholdPicture]];
            ...
            if (self.detailModel.State == 1) {
                ...
                self.inviteBT.backgroundColor = [UIColor redColor];
...
//    }
    ...
    _ageLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(13)];
...
//    _ageLabel.text = [NSString stringWithFormat:@"%@岁",self.detailModel.UAge];
    ...
    _inviteBT.backgroundColor = [UIColor redColor];
    _inviteBT.layer.cornerRadius = SIZE_SCALE_IPHONE6(3);
    _inviteBT.titleLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(15)];
    ...
    _joinBT.backgroundColor = [UIColor redColor];
    ...
    layout.itemSize = CGSizeMake(SIZE_SCALE_IPHONE6(77), SIZE_SCALE_IPHONE6(77));
    ...
    _activeLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(18)];
...
//    _activeLabel.text = self.detailModel.Name;
    ...
    _placeLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(13)];
    ...
    _introLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(13)];
    ...
    _numLabel.font = [UIFont systemFontOfSize:SIZE_SCALE_IPHONE6(13)];
...
-(void)joinAction {
    ...
    [dictory setValue:self.detailModel.GroupID forKey:@"GroupID"];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    if (collectionView.tag == 9990) {
        ...
        [IMV sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://123.57.156.227:8080/AppImages/%@",self.picArray[indexPath.row]]] placeholderImage:[UIImage imageNamed:placeholdPicture]];
        ...
        UIImageView * IMV = [[UIImageView alloc] init];
        [IMV sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://123.57.156.227:8080/AppImages/%@",self.perArray[indexPath.row]]] placeholderImage:[UIImage imageNamed:placeholdPicture]];
        cell.backgroundView = IMV;

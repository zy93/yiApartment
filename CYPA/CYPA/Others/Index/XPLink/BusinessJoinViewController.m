...
//    self.kindButton.backgroundColor = [UIColor yellowColor];
    ...
    self.submitBT.backgroundColor = [UIColor colorWithHexString:kButtonBGColor];
...
-(void)submitAction{
    ...
    if ([self.kindLabel.text isEqualToString:@"美食"]) {
        [dictory setValue:@"07_005_01" forKey:@"SubType"];
    }else if ([self.kindLabel.text isEqualToString:@"电影"]){
        [dictory setValue:@"07_005_02" forKey:@"SubType"];
    }else if ([self.kindLabel.text isEqualToString:@"团购"]){
        [dictory setValue:@"07_005_03" forKey:@"SubType"];
    }else if ([self.kindLabel.text isEqualToString:@"外卖"]){
        [dictory setValue:@"07_005_04" forKey:@"SubType"];
    }else if ([self.kindLabel.text isEqualToString:@"旅行"]){
        [dictory setValue:@"07_005_05" forKey:@"SubType"];
    }else if ([self.kindLabel.text isEqualToString:@"丽人"]){
        [dictory setValue:@"07_005_06" forKey:@"SubType"];
    }else if ([self.kindLabel.text isEqualToString:@"购物"]){
        [dictory setValue:@"07_005_07" forKey:@"SubType"];
    }else if ([self.kindLabel.text isEqualToString:@"出行"]){
    ...
    if (self.kindLabel.text.length == 0 || self.companyTF.text.length == 0 || self.nameTF.text.length == 0 || self.phoneTF.text.length == 0 || self.emailTF.text.length == 0 || self.thingsTF.text.length == 0) {
        ...
        [self showAlertWithString:@"请补全信息"];
    }else{

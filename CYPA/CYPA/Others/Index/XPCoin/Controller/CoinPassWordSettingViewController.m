//
//  CoinPassWordSettingViewController.m
//  CYPA
//
...
@interface CoinPassWordSettingViewController ()<UITableViewDataSource, UITableViewDelegate>
@property(nonatomic, strong)UITableView * tableView;

@end

@implementation CoinPassWordSettingViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        CoinOldPassWordViewController * oldVC = [[CoinOldPassWordViewController alloc] init];

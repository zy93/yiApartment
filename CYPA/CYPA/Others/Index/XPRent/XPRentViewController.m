...
@interface XPRentViewController ()<UIWebViewDelegate>
@property(nonatomic, strong)UIWebView *webView;

@end

@implementation XPRentViewController
...
//    self.webView.frame = CGRectMake(0, CGRectGetMaxY(self.titleImv.frame)+20, self.view.frame.size.width, 300);
    ...
    NSURL * url = [NSURL URLWithString:@"http://www.cypalife.com/rent/leasing_new.html"];
